...
ANUBIS.slider = function(){
    ...
    tpj(document).ready(function() {
        // Verificar que Revolution Slider está cargado
        ...
        // Full Screen Slider (solo si existe el elemento)
        ...
        // Simple Slider (solo si existe el elemento)
        if (tpj('.sliderbanner').length > 0) {
...
$(document).ready(function(){
    ...
    // Slider AL FINAL para evitar romper el resto
    ANUBIS.slider();
});
